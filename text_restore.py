...
# 变体选择符 U+FE00..FE0F (隐形, 常用于 emoji/水印标记)
INVISIBLE_MAP.update({chr(c): '' for c in range(0xFE00, 0xFE10)})
# 隔离控制符 U+2065..2069 (双向隔离)
INVISIBLE_MAP.update({chr(c): '' for c in range(0x2065, 0x206A)})
# 标签字符 U+E0020..E007F (隐形标签块)
INVISIBLE_MAP.update({chr(c): '' for c in range(0xE0020, 0xE0080)})
